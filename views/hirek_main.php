<h1 style="max-width: 10%; margin-left:auto; margin-right: auto; font-size:52pt;">Hírek</h1>

<?php if ($_SESSION['userid'] == 0 || !isset($_SESSION['userid'])) { ?>
    <h2 style="max-width: 50%; margin-left:auto; margin-right: auto;">A hírekhez és a kommenteléshez be kell jelenzkezni!</h2>
<?php } else { ?>
